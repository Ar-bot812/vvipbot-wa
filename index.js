...
const apivhtear = 'Apikey Aziz';
const apibarbar = 'Apikey Aziz';
const BotName = 'VVIPINDO BOT'; 
const instagram = 'wolf_nation_rmx- kaelMk_'; 
const aktif = 'Kapan bot aktif';
const vcard = 'BEGIN:VCARD\n' // metadata of the contact card
            + 'VERSION:3.0\n' 
            + 'FT:Aziz\n' // Aziz
            + 'ORG:VVIPINDO;\n' // Ar Bot
            + 'TEL;type=CELL;type=VOICE;waijd=6288238713432:+62 88238713432\n' //088238713432
            + 'END:VCARD'
const
{
WAConnection,
